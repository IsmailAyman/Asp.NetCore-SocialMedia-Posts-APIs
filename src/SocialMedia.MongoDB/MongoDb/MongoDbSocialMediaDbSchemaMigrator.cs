...
public class MongoDbSocialMediaDbSchemaMigrator : ISocialMediaDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbSocialMediaDbSchemaMigrator(IServiceProvider serviceProvider)
    {
